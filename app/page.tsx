...
export default function Home() {
  return (
    <>
      ...
      <main className={`select-none fixed pointer-events-none h-[100dvh] justify-between py-40 sm:py-24 w-full flex flex-col items-center lowercase text-xl tracking-widest`}>
