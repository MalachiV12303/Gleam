const cameras = [
    {
        ...
        megapixels: 24.1,
        value: 599.99,
        details: JSON.parse('{"res": 1080, "shutter" : "1/4000 to 30 sec", "sd" : ["SD","SDXC","SDHC"], "lens" : ["Canon EF","Canon EF-S"]}'),
    ...
    },
    {
        ...
        megapixels: 20.9,
        value: 849.99,
        details: JSON.parse('{"res": 2160, "shutter" : "1/4000 to 30 sec", "sd" : ["SD","SDXC","SDHC"], "lens" : ["Nikon Z"] }'),
