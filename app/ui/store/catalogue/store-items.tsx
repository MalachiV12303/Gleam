...
export function StoreItem({ item }: { item: Camera | Lense }) {
    ...
    function Camera(cam: Camera) {
        ...
        return (
            <>
                <div className="snap-start gap-2 xl:gap-6 relative px-4 py-4 xl:px-6 xl:py-6 w-full flex text-sm justify-between overflow-hidden">
                    ...
                    <div className='flex justify-end flex-1 items-center'>
                        <div className="w-[100px] h-[100px] sm:w-[150px] sm:h-[150px] xl:w-[200px] xl:h-[200px] border-1 border-foreground flex justify-center items-center">
