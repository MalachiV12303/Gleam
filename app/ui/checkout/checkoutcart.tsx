...
export function CheckoutCart() {
    ...
    return (
        <div className='bg-background relative flex flex-col max-h-[80dvh] h-full border-1 border-foreground px-2'>
            <p className='py-4 px-4 text-lg'>Order summary ({totalItems} {totalItems === 1 ? 'item' : 'items'})</p>
            <div className='overflow-auto no-scrollbar flex-1 flex flex-col gap-4 divide-y-1 divide-foreground'>
            ...
            <div className='px-4 py-2 text-xl w-full flex border-t-1 border-foreground'>
                <span>subtotal:</span>
